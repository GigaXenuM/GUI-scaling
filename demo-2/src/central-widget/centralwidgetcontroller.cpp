...
constexpr int CONTROLS_WIDTH{ 80 };
...
void CentralWidgetController::setup()
{
    ...
    _scaleControlWidget->setFixedWidth(CONTROLS_WIDTH * _scalingFactor);
    _fontControlWidget->setFixedWidth(CONTROLS_WIDTH * _scalingFactor);
    button->setFixedWidth(CONTROLS_WIDTH * _scalingFactor);
